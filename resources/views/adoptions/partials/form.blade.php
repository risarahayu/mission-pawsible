...
<div id="next-question" style="display: none;">
  ...
  <div class="mb-3">
      <label for="future_residency_country" class="form-label">If you leave Bali where would you go? Which country? </label>
  ...
  <div class="mb-3" id="house_occupants">
      <label for="house_occupants" class="form-label" >If you work full time is anyone home with the dogs during the day?</label>
